...
class Controller:
    ...
    def handleCreaGrafo(self, e):
        ...
        self._view.txt_result.controls.append(ft.Text(f"Grafomcorrettamente creato."))
        ...
        listDD = map(lambda x: ft.dropdown.Option(data=x, text=x.Title,
    ...
    def handleAnalisiComp(self, e):
        ...
        self._view.txt_result.controls.clear()
        self._view.txt_result.controls.append(ft.Text(f"La componente connessa che include {self._choiceAlbum} ha dimensione {sizeC}"
                                                      f" e durata totale {totDurata}"))
        self._view.update_page()
    ...
    def handleGetSetAlbum(self, e):
        ...
        try:
            ...
            self._view.txt_result.controls.clear()
            self._view.txt_result.controls.append(ft.Text(f"Soglia non valida, inserire un intero"))
            return
